                ...
                <div className="close-position-radios">
                    <label className="position-radio">
                        ...
                        <div className="radio-subtitle">
                            We will convert the minimum required amount of
                            tokens into SOL to pay bak the debt and return the
                            remaining assets to you. This can potentially save
                            on slipage and trading fees
                        </div>
                    </label>
                    <label className="position-radio">
                        <div className="radio-title">
                            ...
                            <div className="radio-text radio-dropdown-text">
                                Convert to
                            </div>
                        ...
                        <div className="radio-subtitle">
                            Your position value will all be converted to USDT
                            and returned to you after paying back the debt
                        </div>
                    </label>
                </div>
